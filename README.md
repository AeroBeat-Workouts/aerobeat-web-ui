...
- `aero-flow-hud`, `aero-boxing-track-hud`, `aero-boxing-spatial-hud`: mode-specific presentation only; the Flow presenter uses the exact visible `Flow` label (backed by `flow_colliders_v1`) while preserving its public element name.
