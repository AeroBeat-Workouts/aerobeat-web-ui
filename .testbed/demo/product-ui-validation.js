...
/** @param {string} profileId @param {string} contentHash @param {string} profileClass @param {boolean} regenerationRequired */
function tuningIdentity(profileId, contentHash, profileClass, regenerationRequired) { return Object.freeze({ schema: "aerobeat/prototype_tuning_identity", version: 1, profileId, profileVersion: "1.0.0", contentHash, class: profileClass, regenerationRequired }); }
...
selector.setSnapshot({ selectedProfileId: "semantic-row", sessionState: "playing", profileClasses: [
  { class: "live_visual", experimental: true, active: tuningIdentity("aero.visual.default", "fdcf478c91e21ef88970299e29fcc35d574bfe69e0d7d00d9f823ee9507f39a3", "live_visual", false), profiles: [tuningIdentity("aero.visual.default", "fdcf478c91e21ef88970299e29fcc35d574bfe69e0d7d00d9f823ee9507f39a3", "live_visual", false), tuningIdentity("aero.visual.compact", "e65d53dfaafe8a859c08837acb3d447b10b03508bd5ae64677d273c93657d603", "live_visual", false)] },
  { class: "between_run_ruleset", experimental: true, active: tuningIdentity("aero.scoring.locked", "0df07b0502381012cc6f46da3c99edd4a5f4999731e54a440a2785f830c5bda5", "between_run_ruleset", false), profiles: [tuningIdentity("aero.scoring.locked", "0df07b0502381012cc6f46da3c99edd4a5f4999731e54a440a2785f830c5bda5", "between_run_ruleset", false)] },
  { class: "converter_regeneration", experimental: true, active: tuningIdentity("aero.converter.prototype-reach", "e37f8b527ed5ce86738ce22007fc963f83bccd737893fb4728d3b83eaa044eea", "converter_regeneration", true), selectedContentHash: "e37f8b527ed5ce86738ce22007fc963f83bccd737893fb4728d3b83eaa044eea", appliedContentHash: "a43b53a39c13c9e9efe59854aee0fa16efdcd3c6a29bc09f678d94b3fd8f0202", pendingContentHash: "e37f8b527ed5ce86738ce22007fc963f83bccd737893fb4728d3b83eaa044eea", regenerationRequired: true, profiles: [tuningIdentity("aero.converter.canonical", "a43b53a39c13c9e9efe59854aee0fa16efdcd3c6a29bc09f678d94b3fd8f0202", "converter_regeneration", false), tuningIdentity("aero.converter.prototype-reach", "e37f8b527ed5ce86738ce22007fc963f83bccd737893fb4728d3b83eaa044eea", "converter_regeneration", true)] }
] });
app.append(selector);
